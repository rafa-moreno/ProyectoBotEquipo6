...
respuestasSaludo = ["Hola, encantado de conocerte", "¡Buenas!", "¿Me estás hablando a mi?", "¡Hey! ¿Cómo te llamas?"]
...
def comprobarentradafichero(cadenafichero):
    ...
    conversacion = open("conversacion.txt", "a")
    conversacion.writelines(f"\n\t\t{cadenafichero}")
    conversacion.writelines(f"\n{respuesta}")
    conversacion.close()
